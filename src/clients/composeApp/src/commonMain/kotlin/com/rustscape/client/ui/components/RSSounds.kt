...
interface SoundManager {
    ...
    /**
     * Whether audio is currently unlocked and can play.
     * On web platforms, audio requires a user gesture to unlock.
     */
    val isAudioUnlocked: Boolean
    ...
    /**
     * Attempt to unlock audio context. Should be called from a user gesture handler.
     * Returns true if audio was successfully unlocked.
     */
    fun unlockAudio(): Boolean
}
...
class NoOpSoundManager : SoundManager {
    ...
    override val isAudioUnlocked: Boolean = true // Desktop/NoOp doesn't need user gesture
    ...
    override fun unlockAudio(): Boolean = true // Always unlocked on desktop
}
